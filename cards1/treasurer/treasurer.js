/* ================================================================
   ...
   4. Card rotates
   5. Sponsoring emblem reveals
   6. Sponsoring title appears
...
const sponsoringHeader =
    document.querySelector(".sponsoring-header");

const sponsoringTitle =
    document.querySelector(".sponsoring-title");

const sponsoringEmblem =
    document.querySelector(".sponsoring-emblem");

const sponsoringSymbol =
    document.querySelector(".sponsoring-symbol");

const sponsoringScan =
    document.querySelector(".sponsoring-emblem-scan");

const sponsorHands =
    document.querySelectorAll(".sponsor-hand");

const sponsorLink =
    document.querySelector(".sponsor-link");

const sponsorCore =
    document.querySelector(".sponsor-core");
...
const sponsoringHalo =
    document.querySelector(".sponsoring-halo");
...
/* ================================================================
   16. SPONSORING EMBLEM
================================================================ */

async function revealSponsoringEmblem() {

    if (sponsoringHeader) {

        sponsoringHeader.style.opacity =
            "1";
    }
    ...
    if (sponsoringEmblem) {
        ...
        sponsoringEmblem.style.opacity =
            "1";
    }
    ...
    sponsorHands.forEach(
        (hand, index) => {

            if (
                typeof hand.getTotalLength
                !== "function"
            ) {
                return;
            }
            ...
            hand.style.strokeDasharray =
                `${length}`;

            hand.style.strokeDashoffset =
                `${length}`;
    ...
    if (
        sponsorLink &&
        typeof sponsorLink.getTotalLength === "function"
    ) {

        const length =
            sponsorLink.getTotalLength();


        sponsorLink.style.strokeDasharray =
            `${length}`;

        sponsorLink.style.strokeDashoffset =
            `${length}`;
...
async function revealSponsoringTitle() {
...
async function startSequence() {
    ...
    await revealSponsoringEmblem();

    await revealSponsoringTitle();
...
function renderLoop() {
    ...
    if (
        ...
        if (sponsoringEmblem) {
            ...
            sponsoringEmblem.style.translate = `
        ...
        if (sponsoringHalo) {
            ...
            sponsoringHalo.style.translate = `
...
/* ================================================================
   27. AMBIENT SPONSORING SIGNAL
================================================================ */

function ambientSponsoringSignal() {
...
/* ================================================================
   28. PARTNERSHIP CORE BREATH
================================================================ */

function sponsorCoreBreath() {
